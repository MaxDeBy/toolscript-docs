The cross examination instruction, or short CE instruction, is obviously used for processing a cross examination. The container itself is defined similar to a frame:
